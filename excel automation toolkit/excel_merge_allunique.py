#script ni tak buang duplicate dekat source file, just merge unique records from reference file to source file. Output will be saved as new file in output folder. Summary sheet will show metrics about the merge process.
import pandas as pd
import os
